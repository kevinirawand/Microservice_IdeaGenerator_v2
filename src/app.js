...
app.get('/api/data-sharding', async (req, res) => {
   try {
      ...
      await postToServer('http://localhost:5000/api/scrape', shardResult.part_1);

      // await postToServer('http://localhost:6000/api/scrape', shardResult.part_2);

      // await postToServer('http://localhost:7000/api/scrape', shardResult.part_3);

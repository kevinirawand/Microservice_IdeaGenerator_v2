...
function onDateChange() {
   ...
   $.get("./api_gauge", { interval: interval, date: val }, function (result, status) {
...
function initMonthlyGauge(month, year) {
   $.get("./api_gauge", { interval: interval, month: month + 1, year: year }, function (result, status) {

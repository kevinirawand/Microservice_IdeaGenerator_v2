    ...
    <div class="col-sm-4">
        <div class="box">
            <form action="" method="post">
                <?php
                if (isset($row['id_scrap_target']))
                {
                    echo '<input type="hidden" name="id_scrap_target" value="'.$row['id_scrap_target'].'">';
                }
                ?>
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo site_url('scrap_target') ?>" class="btn btn-default">Cancel</a>
                </div>
            </form>
        </div>
    </div>
